...
export default function AdmissionGuidance() {
  ...
  return (
    <div className="pt-24 pb-20 bg-[#F4F6F9] bg-dots-pattern text-[#5A6472]">
      ...
      {/* Hero Banner */}
      <section className="py-20 text-white text-center relative overflow-hidden bg-cover bg-no-repeat" style={{ backgroundImage: `url('${getEmbedImageUrl('/images/bg-admission-hero.png')}')`, backgroundPosition: 'center 60%' }}>
